...
import { Play, Youtube, Upload, ArrowRight, Loader2, AlertCircle } from 'lucide-react';
import { api } from '../lib/api';
import { cn } from '../lib/utils';

export default function PreWorkflow() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const workflowData = {
                name: `Quick Workflow - ${new Date().toLocaleString()}`,
                description: `Auto-generated workflow: Scan ${formData.url} -> Download (No Subs) -> Upload`,
                workflow_data: {
                    nodes: [
                        {
                            id: "scan_1",
                    ...
                    edges: [
                        ...
                        { id: "e2-3", source: "download_1", target: "upload_1" }
                    ]
                }
            };
        ...
        <div className="container mx-auto p-6 max-w-2xl">
            <div className="mb-8">
                ...
                <p className="text-muted-foreground">
                    Scan a channel, download videos (without subtitles), and upload them directly to your account.
                </p>
            </div>
